<%-- 
    Document   : login
    Created on : Jan 26, 2017, 7:14:41 PM
    Author     : Carter
--%>
...
<html>
  ...
  <body class="w3-white">
    ...
    <div class="w3-container">
      ...
      <div id="id01">
        <div class="w3-modal-content w3-light-grey w3-card-8 w3-animate-zoom" style="max-width:600px">
          ...
          <form id="loginForm" class="w3-container w3-light-grey" action="<c:url value='/j_spring_security_login' />" method='POST'>
            ...
            <div class="w3-section">
              ...
              <button class="w3-btn-block w3-indigo w3-section w3-padding" type="submit">Login</button>
            </div>
          </form>
