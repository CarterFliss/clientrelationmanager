<%-- 
    Document   : addevent
    Created on : Jan 26, 2017, 7:18:06 PM
    Author     : Carter
--%>
...
<header class="w3-container" style="padding-top:22px">
  <h5><b><i class="fa fa-dashboard"></i> Add New Event</b></h5>
</header>
...
<div class="w3-row-padding w3-half w3-margin-bottom">
  ...
  <div class="w3-card-4">
    ...
    <form:form method="post" action="save" cssClass="w3-container" commandName="eventlog">
      ...
      <div class="w3-padding-8">
        ...
        <form:input path="interaction" cssClass="w3-input w3-border"  />
